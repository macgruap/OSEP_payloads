...
char WaitForSingleObjectStub[INDIRECT_SYSCALL_STUB_SIZE] = {};
...
BOOL FindWaitForSingleObject(PIMAGE_EXPORT_DIRECTORY exportDirectory, LPVOID fileData, PIMAGE_SECTION_HEADER textSection, PIMAGE_SECTION_HEADER rdataSection)
{
	...
	VirtualProtect(WaitForSingleObjectStub, INDIRECT_SYSCALL_STUB_SIZE, PAGE_EXECUTE_READWRITE, &oldProtection);
